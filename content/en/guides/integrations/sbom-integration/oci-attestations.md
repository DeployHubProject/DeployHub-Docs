...
An **OCI Attestation** is an SBOM or other artifact attached directly to a container image in the registry. This is the first source DeployHub' scanner components check for a container-image release:
