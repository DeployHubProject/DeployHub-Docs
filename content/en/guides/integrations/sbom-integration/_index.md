...
type: guides
description: >
  The sources DeployHub can pull or generate an SBOM from, in priority order.
---

DeployHub (via [`relscanner-job`](../deployment-tracking-github-gitlab/) and the [GKE tracker](../deployment-tracking-gke/)) looks for an SBOM in this general priority order, falling back through each tier before giving up:
