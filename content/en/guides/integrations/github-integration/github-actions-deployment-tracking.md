...
When a repository is onboarded (see [Onboard Repositories](../onboard-repositories/)), DeployHub inspects recent GitHub Actions workflow runs. For each run that completed successfully, it creates:
