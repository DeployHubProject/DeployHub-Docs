...
From **Profile → GitHub Integration**, a user picks which of their installed repositories to onboard (`POST /api/v1/github/onboard`). For each selected `owner/repo`, DeployHub:
