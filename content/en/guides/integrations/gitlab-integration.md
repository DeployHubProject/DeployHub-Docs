...
Unlike GitHub, DeployHub does not currently offer a GitLab App installation flow — GitLab repositories are connected using a personal access token (PAT) instead.
