...
type: guides
description: >
  Run DeployHub on your own infrastructure.
aliases:
  - /guides/initial-setup/choose-your-path/self-hosted-installation/
---

Self-hosting DeployHub means running the backend, database (ArangoDB), and optional scanner components (`relscanner-job`, `osvdev-job`, `deployment-gke`) yourself, typically on Kubernetes.
...
The supported way to deploy DeployHub on Kubernetes is the official Helm chart, published on ArtifactHub:
