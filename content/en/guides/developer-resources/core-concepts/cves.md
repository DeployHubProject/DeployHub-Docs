...
See [How DeployHub Objects Relate](../how-ortelius-objects-relate/) for the hub-and-spoke design that connects CVEs to SBOMs efficiently, and [Sync Records](../sync-records/) for how a match becomes a tracked lifecycle event on a specific deployed endpoint.
