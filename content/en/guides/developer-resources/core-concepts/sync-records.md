...
A **sync** record is the act of telling DeployHub what version is currently deployed to an endpoint.
...
2. CVEs for the new version are fetched from the materialized `release2cve` edges (see [How DeployHub Objects Relate](../how-ortelius-objects-relate/)).
