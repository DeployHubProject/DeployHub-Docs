...
See [Attach or Discover SBOMs](../../../start-here/attach-or-discover-sboms/) for the setup-flow explanation, and [SBOM Integration](../../../integrations/sbom-integration/) for the full list of sources DeployHub can pull an SBOM from (OCI attestations, GitHub Release assets, Syft, cdxgen).
