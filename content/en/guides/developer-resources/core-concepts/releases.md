...
type: guides
description: >
  The versioned unit DeployHub tracks SBOMs, CVEs, and deployments against.
---
...
See [How DeployHub Objects Relate](../how-ortelius-objects-relate/) for how a release connects to SBOMs and CVEs.
