...
There are many ways to contribute to the DeployHub project. Here are the various levels of involvement and how to get there!

## User

Try out DeployHub with the [SaaS version hosted by DeployHub](https://www.deployhub.com/deployhub-team/)
...
If you aren't sure if you are ready, or need help finding sponsors, reach out to the current [chairs](https://www.deployhub.com/contributor).

## Reviewer

After you have contributed to an area of DeployHub for a while, you may be ready to help review pull requests either in just that area, or for the entire repository.

Reviewers have an entry in the *OWNERS* file in the different DeployHub repositories indicating that they are a good candidate to be automatically assigned or suggested as a reviewer for that area of code.
...
If you feel that you are ready to become a maintainer, reach out to a [chair](https://www.deployhub.com/become-a-contributor) and they will help sponsor you. Maintainers are added by approval by the chairs.
...
* Representing the SIG at DeployHub community standup meetings.

If you are interested in becoming a chair, reach out to a [chair](https://www.deployhub.com/become-a-contributor) and they will help sponsor you. Chairs are added by approval from the other chairs.
