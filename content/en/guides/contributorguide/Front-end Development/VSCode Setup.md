...
weight: 20
description: >
  Setting up VS Code for frontend (Next.js) development
---

## Getting Started

The DeployHub frontend ([ortelius/frontend](https://github.com/ortelius/frontend)) is a Next.js application. [Visual Studio Code](https://code.visualstudio.com/) is the recommended editor for all frontend work.
...
The frontend consumes the ortelius REST API, which in turn uses ArangoDB. Run the test database container:
