...
- Downstream - this would be your repository that is forked from an DeployHub repo [sbtaylor15/ortelius-docs](https://github.com/sbtaylor15/ortelius-docs)
...
- Upstream - this would be an DeployHub repository [DeployHubProject/DeployHub-Docs](https://github.com/DeployHubProject/DeployHub-Docs)

## Working scenarios

We want to update the User Guide that is in the [DeployHubProject/DeployHub-Docs](https://github.com/DeployHubProject/DeployHub-Docs) repo.

### First pull request

1) Fork the DeployHub repo
   In GitHub click on the Fork button for the repo you want to make a copy of, i.e. [DeployHubProject/DeployHub-Docs](https://github.com/DeployHubProject/DeployHub-Docs). The fork will be created under
...
3) Tell your local repo about the upstream and downstream repos (this only needs to be done once)
   ...
   ```
   git remote add upstream https://github.com/DeployHubProject/DeployHub-Docs.git
   git remote add downstream  https://github.com/Javailabe/ortelius-docs.git
   ```
   `upstream` holds `https://github.com/DeployHubProject/DeployHub-Docs.git`
