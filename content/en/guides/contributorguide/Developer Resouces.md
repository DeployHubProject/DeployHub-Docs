...
The following tools are needed to contribute to DeployHub code or documentation.
...
- [ArangoDB](https://www.arangodb.com/download/) — graph and multi-model database used by DeployHub
...
Getting started with a Pull Request can be tricky. Check out the [PR Cheat Sheet](https://docs.deployhub.com/guides/contributorguide/pull-request-cheat-sheet/) before starting any changes, since a proper setup will make the merge much easier.
