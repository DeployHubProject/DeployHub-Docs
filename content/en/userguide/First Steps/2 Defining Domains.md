...
|Containes Lifecycles| This specifies that the _Domain_ will include a Pipeline model.  Normally used for Project Domains. |
| Sub-Domains | A list of all Sub-Domains assigned to this _Domain_ including all _Life Cycle Domains_.
