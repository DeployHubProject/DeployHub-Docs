...
The _Environment_ menu option is found on the left of the DeployHub main panel. By selecting the _Environment_ menu, you will be taken to a list of all _Environments_ to which you have access. You can use the Search bar, represented by a funnel icon, to reorder _Environments_ based on _Environment_ Name or _Domain_.
